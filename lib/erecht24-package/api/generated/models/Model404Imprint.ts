 ...
 * 
 * @export
 * @interface Model404Imprint
 */
export interface Model404Imprint {
    /**
     * Englische Fehlerbeschreibung
     * @type {string}
     * @memberof Model404Imprint
     */
    message?: string;
    /**
...
/**
 * Check if a given object implements the Model404Imprint interface.
 */
export function instanceOfModel404Imprint(value: object): boolean {
    return true;
}

export function Model404ImprintFromJSON(json: any): Model404Imprint {
    return Model404ImprintFromJSONTyped(json, false);
}

export function Model404ImprintFromJSONTyped(json: any, ignoreDiscriminator: boolean): Model404Imprint {
    if (json == null) {
        return json;
    }
    return {
...
export function Model404ImprintToJSON(value?: Model404Imprint | null): any {
    if (value == null) {
        return value;
    }
    return {
