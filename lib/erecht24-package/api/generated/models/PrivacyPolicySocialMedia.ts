 ...
 * 
 * @export
 * @interface PrivacyPolicySocialMedia
 */
export interface PrivacyPolicySocialMedia {
    /**
     * 
     * @type {string}
     * @memberof PrivacyPolicySocialMedia
     */
    htmlDe?: string;
    /**
     * 
...
/**
 * Check if a given object implements the PrivacyPolicySocialMedia interface.
 */
export function instanceOfPrivacyPolicySocialMedia(value: object): boolean {
    return true;
}

export function PrivacyPolicySocialMediaFromJSON(json: any): PrivacyPolicySocialMedia {
    return PrivacyPolicySocialMediaFromJSONTyped(json, false);
}

export function PrivacyPolicySocialMediaFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrivacyPolicySocialMedia {
    if (json == null) {
        return json;
    }
    return {
...
export function PrivacyPolicySocialMediaToJSON(value?: PrivacyPolicySocialMedia | null): any {
    if (value == null) {
        return value;
    }
    return {
