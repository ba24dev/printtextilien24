 ...
 */
export function instanceOfPrivacyPolicy(value: object): boolean {
    return true;
}
...
export function PrivacyPolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrivacyPolicy {
    ...
    return {
        ...
        'dsgalt': json['dsgalt'] == null ? undefined : json['dsgalt'],
    };
}

export function PrivacyPolicyToJSON(value?: PrivacyPolicy | null): any {
    if (value == null) {
        return value;
    }
    return {
