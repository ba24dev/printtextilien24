 ...
 * 
 * @export
 * @interface Model404PrivacyPolicy
 */
export interface Model404PrivacyPolicy {
    /**
     * Englische Fehlerbeschreibung
     * @type {string}
     * @memberof Model404PrivacyPolicy
     */
    message?: string;
    /**
...
/**
 * Check if a given object implements the Model404PrivacyPolicy interface.
 */
export function instanceOfModel404PrivacyPolicy(value: object): boolean {
    return true;
}

export function Model404PrivacyPolicyFromJSON(json: any): Model404PrivacyPolicy {
    return Model404PrivacyPolicyFromJSONTyped(json, false);
}

export function Model404PrivacyPolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): Model404PrivacyPolicy {
    if (json == null) {
        return json;
    }
    return {
...
export function Model404PrivacyPolicyToJSON(value?: Model404PrivacyPolicy | null): any {
    if (value == null) {
        return value;
    }
    return {
