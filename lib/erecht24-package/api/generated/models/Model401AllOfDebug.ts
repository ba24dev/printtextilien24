 ...
 * @export
 * @interface Model401AllOfDebug
 */
export interface Model401AllOfDebug {
    /**
     * Token aus der Request des Users.
     * @type {string}
     * @memberof Model401AllOfDebug
     */
    token?: string;
}

/**
 * Check if a given object implements the Model401AllOfDebug interface.
 */
export function instanceOfModel401AllOfDebug(value: object): boolean {
    return true;
}

export function Model401AllOfDebugFromJSON(json: any): Model401AllOfDebug {
    return Model401AllOfDebugFromJSONTyped(json, false);
}

export function Model401AllOfDebugFromJSONTyped(json: any, ignoreDiscriminator: boolean): Model401AllOfDebug {
    if (json == null) {
        return json;
    }
    return {
...
export function Model401AllOfDebugToJSON(value?: Model401AllOfDebug | null): any {
    if (value == null) {
        return value;
    }
    return {
