...
import type { Model401AllOfDebug } from './Model401AllOfDebug';
import {
    Model401AllOfDebugFromJSON,
    Model401AllOfDebugFromJSONTyped,
    Model401AllOfDebugToJSON,
} from './Model401AllOfDebug';
...
export interface Model401 {
    ...
    /**
     * 
     * @type {Model401AllOfDebug}
     * @memberof Model401
     */
    debug?: Model401AllOfDebug;
}

/**
 * Check if a given object implements the Model401 interface.
 */
export function instanceOfModel401(value: object): boolean {
    return true;
}
...
export function Model401FromJSONTyped(json: any, ignoreDiscriminator: boolean): Model401 {
    ...
    return {
        ...
        'debug': json['debug'] == null ? undefined : Model401AllOfDebugFromJSON(json['debug']),
    };
}
...
export function Model401ToJSON(value?: Model401 | null): any {
    ...
    return {
        ...
        'debug': Model401AllOfDebugToJSON(value['debug']),
    };
}
