 ...
 * 
 * @export
 * @interface Model404PrivacyPolicySocialMedia
 */
export interface Model404PrivacyPolicySocialMedia {
    /**
     * Englische Fehlerbeschreibung
     * @type {string}
     * @memberof Model404PrivacyPolicySocialMedia
     */
    message?: string;
    /**
...
/**
 * Check if a given object implements the Model404PrivacyPolicySocialMedia interface.
 */
export function instanceOfModel404PrivacyPolicySocialMedia(value: object): boolean {
    return true;
}

export function Model404PrivacyPolicySocialMediaFromJSON(json: any): Model404PrivacyPolicySocialMedia {
    return Model404PrivacyPolicySocialMediaFromJSONTyped(json, false);
}

export function Model404PrivacyPolicySocialMediaFromJSONTyped(json: any, ignoreDiscriminator: boolean): Model404PrivacyPolicySocialMedia {
    if (json == null) {
        return json;
    }
    return {
        ...
        'messageDe': json['message_de'] == null ? undefined : json['message_de'],
        'faqLink': json['faq_link'] == null ? undefined : json['faq_link'],
        'errorCode': json['error_code'] == null ? undefined : json['error_code'],
    };
}

export function Model404PrivacyPolicySocialMediaToJSON(value?: Model404PrivacyPolicySocialMedia | null): any {
    if (value == null) {
        return value;
    }
    return {
