...
/**
 * Check if a given object implements the Model503 interface.
 */
export function instanceOfModel503(value: object): boolean {
    return true;
}

export function Model503FromJSON(json: any): Model503 {
    return Model503FromJSONTyped(json, false);
}

export function Model503FromJSONTyped(json: any, ignoreDiscriminator: boolean): Model503 {
    if (json == null) {
        return json;
    }
    return {
...
export function Model503ToJSON(value?: Model503 | null): any {
    if (value == null) {
        return value;
    }
    return {
