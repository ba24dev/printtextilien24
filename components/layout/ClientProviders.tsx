"use client";
import { ErrorCopy } from "@/config/copy";
...
const countryIsoCode =
  (process.env.NEXT_PUBLIC_SHOPIFY_COUNTRY_ISO_CODE as CountryCode | undefined) ?? "DE";
const languageIsoCode =
  (process.env.NEXT_PUBLIC_SHOPIFY_LANGUAGE_ISO_CODE as LanguageCode | undefined) ?? "DE";

if (!storeDomain || !storefrontToken || !storefrontApiVersion) {
  throw new Error(ErrorCopy.missingShopifyConfig);
}
